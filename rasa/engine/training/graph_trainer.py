...
class DistGraphTrainer:
    ...
    def train_dist(
        ...
        Returns:
            The metadata describing the trained model.
        """
        logger.debug("Starting Ray distributed training.")
...
def custom_deserializer(model_storage, cache, graph_runner_class):
    return DistGraphTrainer(model_storage, cache, graph_runner_class)
